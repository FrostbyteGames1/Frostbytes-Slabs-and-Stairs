...
public class ModScreenHandlers {
    public static ScreenHandlerType<SawmillScreenHandler> SAWMILL_SCREEN_HANDLER =
            new ScreenHandlerType<>(SawmillScreenHandler::new, null);

    public static void registerAllScreenHandlers() {
        Registry.register(Registries.SCREEN_HANDLER, new Identifier(SlabsAndStairs.MOD_ID, "sawmill"), SAWMILL_SCREEN_HANDLER);
    }
}