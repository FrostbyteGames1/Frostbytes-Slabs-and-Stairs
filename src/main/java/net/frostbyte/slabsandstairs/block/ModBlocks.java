...
public class ModBlocks {
    ...
    public static final Block OAK_LEAF_LAYER = register("oak_leaf_layer",
            new LeafLayerBlock(0.01F, OAK_LEAVES, OAK_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "oak_leaf_layer")))
            )
    );

    public static final Block SPRUCE_LEAF_LAYER = register("spruce_leaf_layer",
            new LeafLayerBlock(0, SPRUCE_LEAVES, SPRUCE_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "spruce_leaf_layer")))
            )
    );

    public static final Block BIRCH_LEAF_LAYER = register("birch_leaf_layer",
            new LeafLayerBlock(0.01F, BIRCH_LEAVES, BIRCH_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "birch_leaf_layer")))
            )
    );

    public static final Block JUNGLE_LEAF_LAYER = register("jungle_leaf_layer",
            new LeafLayerBlock(0.01F, JUNGLE_LEAVES, JUNGLE_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "jungle_leaf_layer")))
            )
    );

    public static final Block ACACIA_LEAF_LAYER = register("acacia_leaf_layer",
            new LeafLayerBlock(0.01F, ACACIA_LEAVES, ACACIA_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "acacia_leaf_layer")))
            )
    );

    public static final Block DARK_OAK_LEAF_LAYER = register("dark_oak_leaf_layer",
            new LeafLayerBlock(0.01F, DARK_OAK_LEAVES, DARK_OAK_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_oak_leaf_layer")))
            )
    );

    public static final Block MANGROVE_LEAF_LAYER = register("mangrove_leaf_layer",
            new LeafLayerBlock(0.01F, MANGROVE_LEAVES, MANGROVE_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "mangrove_leaf_layer")))
            )
    );

    public static final Block CHERRY_LEAF_LAYER = register("cherry_leaf_layer",
            new LeafLayerBlock(0.01F, CHERRY_LEAVES, CHERRY_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cherry_leaf_layer")))
            )
    );

    public static final Block PALE_OAK_LEAF_LAYER = register("pale_oak_leaf_layer",
            new LeafLayerBlock(0.01F, PALE_OAK_LEAVES, PALE_OAK_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "pale_oak_leaf_layer")))
            )
    );

    public static final Block AZALEA_LEAF_LAYER = register("azalea_leaf_layer",
            new LeafLayerBlock(0.01F, AZALEA_LEAVES, AZALEA_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "azalea_leaf_layer")))
            )
    );

    public static final Block FLOWERING_AZALEA_LEAF_LAYER = register("flowering_azalea_leaf_layer",
            new LeafLayerBlock(0.01F, FLOWERING_AZALEA_LEAVES, FLOWERING_AZALEA_LEAVES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "flowering_azalea_leaf_layer")))
            )
    );
    ...
    public static final Block SAND_LAYER = register("sand_layer",
            new FallingLayerBlock(new ColorRGBA(14406560), SAND, SAND.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "sand_layer")))
            )
    );

    public static final Block GRAVEL_LAYER = register("gravel_layer",
            new FallingLayerBlock(new ColorRGBA(-8356741), GRAVEL, GRAVEL.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "gravel_layer")))
            )
    );
    ...
    public static final Block COPPER_BUTTON = register("copper_button",
            new OxidizableButtonBlock(WeatheringCopper.WeatherState.UNAFFECTED, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "copper_button"))),
                    10
            )
    );

    public static final Block WAXED_COPPER_BUTTON = register("waxed_copper_button",
            new ButtonBlock(BlockSetType.GOLD, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_copper_button")))
            )
    );

    public static final Block EXPOSED_COPPER_BUTTON = register("exposed_copper_button",
            new OxidizableButtonBlock(WeatheringCopper.WeatherState.EXPOSED, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "exposed_copper_button"))),
                    20
            )
    );

    public static final Block WAXED_EXPOSED_COPPER_BUTTON = register("waxed_exposed_copper_button",
            new ButtonBlock(BlockSetType.GOLD, 20, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_exposed_copper_button")))
            )
    );

    public static final Block WEATHERED_COPPER_BUTTON = register("weathered_copper_button",
            new OxidizableButtonBlock(WeatheringCopper.WeatherState.WEATHERED, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "weathered_copper_button"))),
                    30
            )
    );

    public static final Block WAXED_WEATHERED_COPPER_BUTTON = register("waxed_weathered_copper_button",
            new ButtonBlock(BlockSetType.GOLD, 30, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_weathered_copper_button")))
            )
    );

    public static final Block OXIDIZED_COPPER_BUTTON = register("oxidized_copper_button",
            new OxidizableButtonBlock(WeatheringCopper.WeatherState.OXIDIZED, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "oxidized_copper_button"))),
                    40
            )
    );

    public static final Block WAXED_OXIDIZED_COPPER_BUTTON = register("waxed_oxidized_copper_button",
            new ButtonBlock(BlockSetType.GOLD, 40, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_oxidized_copper_button")))
            )
    );

    public static final Block IRON_BUTTON = register("iron_button",
            new ButtonBlock(BlockSetType.GOLD, 35, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "iron_button")))
            )
    );

    public static final Block GOLD_BUTTON = register("gold_button",
            new ButtonBlock(BlockSetType.GOLD, 15, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "gold_button")))
            )
    );

    public static final Block NETHERITE_BUTTON = register("netherite_button",
            new ButtonBlock(BlockSetType.GOLD, 50, NETHERITE_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "netherite_button")))
            )
    );
    ...
    public static final Block DIORITE_BUTTON = register("diorite_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "diorite_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block ANDESITE_BUTTON = register("andesite_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "andesite_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block GRANITE_BUTTON = register("granite_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "granite_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block SANDSTONE_BUTTON = register("sandstone_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "sandstone_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block RED_SANDSTONE_BUTTON = register("red_sandstone_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "red_sandstone_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block BASALT_BUTTON = register("basalt_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "basalt_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block BLACKSTONE_BUTTON = register("blackstone_button",
            new ButtonBlock(BlockSetType.POLISHED_BLACKSTONE, 10, POLISHED_BLACKSTONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "blackstone_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block CALCITE_BUTTON = register("calcite_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "calcite_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block TUFF_BUTTON = register("tuff_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "tuff_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block DEEPSLATE_BUTTON = register("deepslate_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "deepslate_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block DRIPSTONE_BUTTON = register("dripstone_button",
            new ButtonBlock(BlockSetType.STONE, 10, STONE_BUTTON.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dripstone_button")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block COPPER_PRESSURE_PLATE = register("copper_pressure_plate",
            new OxidizablePressurePlateBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockSetType.GOLD, OAK_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "copper_pressure_plate")))
            )
    );

    public static final Block WAXED_COPPER_PRESSURE_PLATE = register("waxed_copper_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD, LIGHT_WEIGHTED_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_copper_pressure_plate")))
            )
    );

    public static final Block EXPOSED_COPPER_PRESSURE_PLATE = register("exposed_copper_pressure_plate",
            new OxidizablePressurePlateBlock(WeatheringCopper.WeatherState.EXPOSED, BlockSetType.GOLD, LIGHT_WEIGHTED_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "exposed_copper_pressure_plate")))
            )
    );

    public static final Block WAXED_EXPOSED_COPPER_PRESSURE_PLATE = register("waxed_exposed_copper_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD, LIGHT_WEIGHTED_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_exposed_copper_pressure_plate")))
            )
    );

    public static final Block WEATHERED_COPPER_PRESSURE_PLATE = register("weathered_copper_pressure_plate",
            new OxidizablePressurePlateBlock(WeatheringCopper.WeatherState.WEATHERED, BlockSetType.GOLD, HEAVY_WEIGHTED_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "weathered_copper_pressure_plate")))
            )
    );

    public static final Block WAXED_WEATHERED_COPPER_PRESSURE_PLATE = register("waxed_weathered_copper_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD, HEAVY_WEIGHTED_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_weathered_copper_pressure_plate")))
            )
    );

    public static final Block OXIDIZED_COPPER_PRESSURE_PLATE = register("oxidized_copper_pressure_plate",
            new OxidizablePressurePlateBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockSetType.GOLD, HEAVY_WEIGHTED_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "oxidized_copper_pressure_plate")))
            )
    );

    public static final Block WAXED_OXIDIZED_COPPER_PRESSURE_PLATE = register("waxed_oxidized_copper_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD, HEAVY_WEIGHTED_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "waxed_oxidized_copper_pressure_plate")))
            )
    );

    public static final Block NETHERITE_PRESSURE_PLATE = register("netherite_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD, NETHERITE_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "netherite_pressure_plate")))
            )
    );
    ...
    public static final Block DIORITE_PRESSURE_PLATE = register("diorite_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "diorite_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block ANDESITE_PRESSURE_PLATE = register("andesite_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "andesite_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block GRANITE_PRESSURE_PLATE = register("granite_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "granite_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block SANDSTONE_PRESSURE_PLATE = register("sandstone_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "sandstone_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block RED_SANDSTONE_PRESSURE_PLATE = register("red_sandstone_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "red_sandstone_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block BASALT_PRESSURE_PLATE = register("basalt_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "basalt_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block BLACKSTONE_PRESSURE_PLATE = register("blackstone_pressure_plate",
            new PressurePlateBlock(BlockSetType.POLISHED_BLACKSTONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "blackstone_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block CALCITE_PRESSURE_PLATE = register("calcite_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "calcite_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block TUFF_PRESSURE_PLATE = register("tuff_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "tuff_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block DEEPSLATE_PRESSURE_PLATE = register("deepslate_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "deepslate_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
    ...
    public static final Block DRIPSTONE_PRESSURE_PLATE = register("dripstone_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, STONE_PRESSURE_PLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dripstone_pressure_plate")))
                    .strength(0.5f)
                    .requiresCorrectToolForDrops()
                    .noCollision()
            )
...
// Stone Fences:
    ...
    public static final Block RED_NETHER_BRICK_FENCE = register("red_nether_brick_fence",
            new FenceBlock(NETHER_BRICK_FENCE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "red_nether_brick_fence")))
                    .strength(2.0f)
                    .requiresCorrectToolForDrops()
            )
    );
...
// Fence Gates:
    ...
    public static final Block NETHER_BRICK_FENCE_GATE = register("nether_brick_fence_gate",
            new FenceGateBlock(WoodType.CRIMSON, NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "nether_brick_fence_gate")))
                    .strength(2.0f)
                    .requiresCorrectToolForDrops()
            )
    );
    ...
    public static final Block RED_NETHER_BRICK_FENCE_GATE = register("red_nether_brick_fence_gate",
            new FenceGateBlock(WoodType.CRIMSON, RED_NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "red_nether_brick_fence_gate")))
                    .strength(2.0f)
                    .requiresCorrectToolForDrops()
            )
    );
    ...
    public static final Block OAK_WALL = register("oak_wall",
            new WallBlock(OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "oak_wall")))
            )
    );

    public static final Block SPRUCE_WALL = register("spruce_wall",
            new WallBlock(SPRUCE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "spruce_wall")))
            )
    );

    public static final Block BIRCH_WALL = register("birch_wall",
            new WallBlock(BIRCH_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "birch_wall")))
            )
    );

    public static final Block JUNGLE_WALL = register("jungle_wall",
            new WallBlock(JUNGLE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "jungle_wall")))
            )
    );

    public static final Block ACACIA_WALL = register("acacia_wall",
            new WallBlock(ACACIA_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "acacia_wall")))
            )
    );

    public static final Block DARK_OAK_WALL = register("dark_oak_wall",
            new WallBlock(DARK_OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_oak_wall")))
            )
    );

    public static final Block MANGROVE_WALL = register("mangrove_wall",
            new WallBlock(MANGROVE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "mangrove_wall")))
            )
    );

    public static final Block CHERRY_WALL = register("cherry_wall",
            new WallBlock(CHERRY_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cherry_wall")))
            )
    );

    public static final Block BAMBOO_WALL = register("bamboo_wall",
            new WallBlock(BAMBOO_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "bamboo_wall")))
            )
    );

    public static final Block WARPED_WALL = register("warped_wall",
            new WallBlock(WARPED_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "warped_wall")))
            )
    );

    public static final Block CRIMSON_WALL = register("crimson_wall",
            new WallBlock(CRIMSON_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crimson_wall")))
            )
    );

    public static final Block PALE_OAK_WALL = register("pale_oak_wall",
            new WallBlock(PALE_OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "pale_oak_wall")))
            )
    );
    ...
    public static final Block SPRUCE_WOOD_WALL = register("spruce_wood_wall",
            new WallBlock(SPRUCE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "spruce_wood_wall")))
            )
    );

    public static final Block BIRCH_WOOD_WALL = register("birch_wood_wall",
            new WallBlock(BIRCH_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "birch_wood_wall")))
            )
    );

    public static final Block JUNGLE_WOOD_WALL = register("jungle_wood_wall",
            new WallBlock(JUNGLE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "jungle_wood_wall")))
            )
    );

    public static final Block ACACIA_WOOD_WALL = register("acacia_wood_wall",
            new WallBlock(ACACIA_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "acacia_wood_wall")))
            )
    );

    public static final Block DARK_OAK_WOOD_WALL = register("dark_oak_wood_wall",
            new WallBlock(DARK_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_oak_wood_wall")))
            )
    );

    public static final Block MANGROVE_WOOD_WALL = register("mangrove_wood_wall",
            new WallBlock(MANGROVE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "mangrove_wood_wall")))
            )
    );

    public static final Block CHERRY_WOOD_WALL = register("cherry_wood_wall",
            new WallBlock(CHERRY_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cherry_wood_wall")))
            )
    );

    public static final Block BAMBOO_BLOCK_WALL = register("bamboo_block_wall",
            new WallBlock(BAMBOO_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "bamboo_block_wall")))
            )
    );

    public static final Block WARPED_HYPHAE_WALL = register("warped_hyphae_wall",
            new WallBlock(WARPED_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "warped_hyphae_wall")))
            )
    );

    public static final Block CRIMSON_HYPHAE_WALL = register("crimson_hyphae_wall",
            new WallBlock(CRIMSON_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crimson_hyphae_wall")))
            )
    );

    public static final Block PALE_OAK_WOOD_WALL = register("pale_oak_wood_wall",
            new WallBlock(PALE_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "pale_oak_wood_wall")))
            )
    );
    ...
    public static final Block STRIPPED_SPRUCE_WALL = register("stripped_spruce_wall",
            new WallBlock(STRIPPED_SPRUCE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_spruce_wall")))
            )
    );

    public static final Block STRIPPED_BIRCH_WALL = register("stripped_birch_wall",
            new WallBlock(STRIPPED_BIRCH_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_birch_wall")))
            )
    );

    public static final Block STRIPPED_JUNGLE_WALL = register("stripped_jungle_wall",
            new WallBlock(STRIPPED_JUNGLE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_jungle_wall")))
            )
    );

    public static final Block STRIPPED_ACACIA_WALL = register("stripped_acacia_wall",
            new WallBlock(STRIPPED_ACACIA_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_acacia_wall")))
            )
    );

    public static final Block STRIPPED_DARK_OAK_WALL = register("stripped_dark_oak_wall",
            new WallBlock(STRIPPED_DARK_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_dark_oak_wall")))
            )
    );

    public static final Block STRIPPED_MANGROVE_WALL = register("stripped_mangrove_wall",
            new WallBlock(MANGROVE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_mangrove_wall")))
            )
    );

    public static final Block STRIPPED_CHERRY_WALL = register("stripped_cherry_wall",
            new WallBlock(STRIPPED_CHERRY_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_cherry_wall")))
            )
    );

    public static final Block STRIPPED_BAMBOO_WALL = register("stripped_bamboo_wall",
            new WallBlock(BAMBOO_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_bamboo_wall")))
            )
    );

    public static final Block STRIPPED_WARPED_WALL = register("stripped_warped_wall",
            new WallBlock(STRIPPED_WARPED_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_warped_wall")))
            )
    );

    public static final Block STRIPPED_CRIMSON_WALL = register("stripped_crimson_wall",
            new WallBlock(STRIPPED_CRIMSON_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_crimson_wall")))
            )
    );
    ...
    public static final Block ICE_WALL = register("ice_wall",
            new IceWallBlock(ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "ice_wall")))
            )
    );

    public static final Block PACKED_ICE_WALL = register("packed_ice_wall",
            new WallBlock(PACKED_ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "packed_ice_wall")))
            )
    );

    public static final Block BLUE_ICE_WALL = register("blue_ice_wall",
            new WallBlock(BLUE_ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "blue_ice_wall")))
            )
    );
    ...
    public static final Block IRON_WALL = register("iron_wall",
            new WallBlock(IRON_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "iron_wall")))
            )
    );

    public static final Block GOLD_WALL = register("gold_wall",
            new WallBlock(GOLD_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "gold_wall")))
            )
    );

    public static final Block NETHERITE_WALL = register("netherite_wall",
            new WallBlock(NETHERITE_BLOCK.properties().sound(SoundType.NETHERITE_BLOCK)
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "netherite_wall")))
            )
    );
    ...
    public static final Block STONE_WALL = register("stone_wall",
            new WallBlock(STONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stone_wall")))
            )
    );

    public static final Block CHISELED_STONE_BRICK_WALL = register("chiseled_stone_brick_wall",
            new WallBlock(CHISELED_STONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_stone_brick_wall")))
            )
    );

    public static final Block CRACKED_STONE_BRICK_WALL = register("cracked_stone_brick_wall",
            new WallBlock(CRACKED_STONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_stone_brick_wall")))
            )
    );

    public static final Block SMOOTH_STONE_WALL = register("smooth_stone_wall",
            new WallBlock(SMOOTH_STONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_stone_wall")))
            )
    );

    public static final Block POLISHED_DIORITE_WALL = register("polished_diorite_wall",
            new WallBlock(POLISHED_DIORITE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "polished_diorite_wall")))
            )
    );

    public static final Block POLISHED_ANDESITE_WALL = register("polished_andesite_wall",
            new WallBlock(POLISHED_ANDESITE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "polished_andesite_wall")))
            )
    );

    public static final Block POLISHED_GRANITE_WALL = register("polished_granite_wall",
            new WallBlock(POLISHED_GRANITE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "polished_granite_wall")))
            )
    );

    public static final Block CHISELED_SANDSTONE_WALL = register("chiseled_sandstone_wall",
            new WallBlock(CHISELED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_sandstone_wall")))
            )
    );

    public static final Block CUT_SANDSTONE_WALL = register("cut_sandstone_wall",
            new WallBlock(CUT_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cut_sandstone_wall")))
            )
    );

    public static final Block SMOOTH_SANDSTONE_WALL = register("smooth_sandstone_wall",
            new WallBlock(SMOOTH_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_sandstone_wall")))
            )
    );

    public static final Block CHISELED_RED_SANDSTONE_WALL = register("chiseled_red_sandstone_wall",
            new WallBlock(CHISELED_RED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_red_sandstone_wall")))
            )
    );

    public static final Block CUT_RED_SANDSTONE_WALL = register("cut_red_sandstone_wall",
            new WallBlock(CUT_RED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cut_red_sandstone_wall")))
            )
    );

    public static final Block SMOOTH_RED_SANDSTONE_WALL = register("smooth_red_sandstone_wall",
            new WallBlock(SMOOTH_RED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_red_sandstone_wall")))
            )
    );

    public static final Block BASALT_WALL = register("basalt_wall",
            new WallBlock(BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "basalt_wall")))
            )
    );

    public static final Block SMOOTH_BASALT_WALL = register("smooth_basalt_wall",
            new WallBlock(SMOOTH_BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_basalt_wall")))
            )
    );

    public static final Block POLISHED_BASALT_WALL = register("polished_basalt_wall",
            new WallBlock(POLISHED_BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "polished_basalt_wall")))
            )
    );

    public static final Block CHISELED_POLISHED_BLACKSTONE_WALL = register("chiseled_polished_blackstone_wall",
            new WallBlock(CHISELED_POLISHED_BLACKSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_polished_blackstone_wall")))
            )
    );

    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_WALL = register("cracked_polished_blackstone_brick_wall",
            new WallBlock(CRACKED_POLISHED_BLACKSTONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_polished_blackstone_brick_wall")))
            )
    );

    public static final Block CALCITE_WALL = register("calcite_wall",
            new WallBlock(CALCITE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "calcite_wall")))
            )
    );

    public static final Block CHISELED_TUFF_WALL = register("chiseled_tuff_wall",
            new WallBlock(CHISELED_TUFF.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_tuff_wall")))
            )
    );

    public static final Block CHISELED_TUFF_BRICK_WALL = register("chiseled_tuff_brick_wall",
            new WallBlock(CHISELED_TUFF_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_tuff_brick_wall")))
            )
    );

    public static final Block DEEPSLATE_WALL = register("deepslate_wall",
            new WallBlock(DEEPSLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "deepslate_wall")))
            )
    );

    public static final Block CHISELED_DEEPSLATE_WALL = register("chiseled_deepslate_wall",
            new WallBlock(CHISELED_DEEPSLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_deepslate_wall")))
            )
    );

    public static final Block CRACKED_DEEPSLATE_BRICK_WALL = register("cracked_deepslate_brick_wall",
            new WallBlock(CRACKED_DEEPSLATE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_deepslate_brick_wall")))
            )
    );

    public static final Block CRACKED_DEEPSLATE_TILE_WALL = register("cracked_deepslate_tile_wall",
            new WallBlock(CRACKED_DEEPSLATE_TILES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_deepslate_tile_wall")))
            )
    );

    public static final Block DRIPSTONE_WALL = register("dripstone_wall",
            new WallBlock(DRIPSTONE_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dripstone_wall")))
            )
    );

    public static final Block PRISMARINE_BRICK_WALL = register("prismarine_brick_wall",
            new WallBlock(PRISMARINE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "prismarine_brick_wall")))
            )
    );

    public static final Block DARK_PRISMARINE_WALL = register("dark_prismarine_wall",
            new WallBlock(DARK_PRISMARINE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_prismarine_wall")))
            )
    );

    public static final Block CRACKED_NETHER_BRICK_WALL = register("cracked_nether_brick_wall",
            new WallBlock(CRACKED_NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_nether_brick_wall")))
            )
    );

    public static final Block CHISELED_NETHER_BRICK_WALL = register("chiseled_nether_brick_wall",
            new WallBlock(CHISELED_NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_nether_brick_wall")))
            )
    );

    public static final Block QUARTZ_WALL = register("quartz_wall",
            new WallBlock(QUARTZ_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "quartz_wall")))
            )
    );

    public static final Block QUARTZ_BRICK_WALL = register("quartz_brick_wall",
            new WallBlock(QUARTZ_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "quartz_brick_wall")))
            )
    );

    public static final Block CHISELED_QUARTZ_WALL = register("chiseled_quartz_wall",
            new WallBlock(CHISELED_QUARTZ_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_quartz_wall")))
            )
    );

    public static final Block SMOOTH_QUARTZ_WALL = register("smooth_quartz_wall",
            new WallBlock(SMOOTH_QUARTZ.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_quartz_wall")))
            )
    );

    public static final Block QUARTZ_PILLAR_WALL = register("quartz_pillar_wall",
            new WallBlock(QUARTZ_PILLAR.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "quartz_pillar_wall")))
            )
    );

    public static final Block END_STONE_WALL = register("end_stone_wall",
            new WallBlock(END_STONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "end_stone_wall")))
            )
    );

    public static final Block PURPUR_WALL = register("purpur_wall",
            new WallBlock(PURPUR_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "purpur_wall")))
            )
    );

    public static final Block PURPUR_PILLAR_WALL = register("purpur_pillar_wall",
            new WallBlock(PURPUR_PILLAR.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "purpur_pillar_wall")))
            )
    );

    public static final Block OBSIDIAN_WALL = register("obsidian_wall",
            new WallBlock(OBSIDIAN.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "obsidian_wall")))
            )
    );

    public static final Block CRYING_OBSIDIAN_WALL = register("crying_obsidian_wall",
            new WallBlock(CRYING_OBSIDIAN.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crying_obsidian_wall")))
            )
    );
    ...
    public static final Block TERRACOTTA_WALL = register("terracotta_wall",
            new WallBlock(TERRACOTTA.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "terracotta_wall")))
            )
    );
    ...
    public static final Block IRON_SLAB = register("iron_slab",
            new SlabBlock(IRON_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "iron_block")))
            )
    );

    public static final Block GOLD_SLAB = register("gold_slab",
            new SlabBlock(GOLD_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "gold_block")))
            )
    );

    public static final Block NETHERITE_SLAB = register("netherite_slab",
            new SlabBlock(NETHERITE_BLOCK.properties().sound(SoundType.NETHERITE_BLOCK)
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "netherite_block")))
            )
    );
    ...
    public static final Block OAK_LOG_SLAB = register("oak_log_slab",
            new SlabBlock(OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "oak_log")))
            )
    );

    public static final Block SPRUCE_LOG_SLAB = register("spruce_log_slab",
            new SlabBlock(SPRUCE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "spruce_log")))
            )
    );

    public static final Block BIRCH_LOG_SLAB = register("birch_log_slab",
            new SlabBlock(BIRCH_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "birch_log")))
            )
    );

    public static final Block JUNGLE_LOG_SLAB = register("jungle_log_slab",
            new SlabBlock(JUNGLE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "jungle_log")))
            )
    );

    public static final Block ACACIA_LOG_SLAB = register("acacia_log_slab",
            new SlabBlock(ACACIA_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "acacia_log")))
            )
    );

    public static final Block DARK_OAK_LOG_SLAB = register("dark_oak_log_slab",
            new SlabBlock(DARK_OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_oak_log")))
            )
    );

    public static final Block MANGROVE_LOG_SLAB = register("mangrove_log_slab",
            new SlabBlock(MANGROVE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "mangrove_log")))
            )
    );

    public static final Block CHERRY_LOG_SLAB = register("cherry_log_slab",
            new SlabBlock(CHERRY_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cherry_log")))
            )
    );

    public static final Block WARPED_STEM_SLAB = register("warped_stem_slab",
            new SlabBlock(WARPED_STEM.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "warped_stem")))
            )
    );

    public static final Block CRIMSON_STEM_SLAB = register("crimson_stem_slab",
            new SlabBlock(CRIMSON_STEM.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crimson_stem")))
            )
    );

    public static final Block PALE_OAK_LOG_SLAB = register("pale_oak_log_slab",
            new SlabBlock(PALE_OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "pale_oak_log")))
            )
    );
    ...
    public static final Block SPRUCE_WOOD_SLAB = register("spruce_wood_slab",
            new SlabBlock(SPRUCE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "spruce_wood")))
            )
    );

    public static final Block BIRCH_WOOD_SLAB = register("birch_wood_slab",
            new SlabBlock(BIRCH_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "birch_wood")))
            )
    );

    public static final Block JUNGLE_WOOD_SLAB = register("jungle_wood_slab",
            new SlabBlock(JUNGLE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "jungle_wood")))
            )
    );

    public static final Block ACACIA_WOOD_SLAB = register("acacia_wood_slab",
            new SlabBlock(ACACIA_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "acacia_wood")))
            )
    );

    public static final Block DARK_OAK_WOOD_SLAB = register("dark_oak_wood_slab",
            new SlabBlock(DARK_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_oak_wood")))
            )
    );

    public static final Block MANGROVE_WOOD_SLAB = register("mangrove_wood_slab",
            new SlabBlock(MANGROVE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "mangrove_wood")))
            )
    );

    public static final Block CHERRY_WOOD_SLAB = register("cherry_wood_slab",
            new SlabBlock(CHERRY_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cherry_wood")))
            )
    );

    public static final Block BAMBOO_BLOCK_SLAB = register("bamboo_block_slab",
            new SlabBlock(BAMBOO_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "bamboo_block")))
            )
    );

    public static final Block WARPED_HYPHAE_SLAB = register("warped_hyphae_slab",
            new SlabBlock(WARPED_STEM.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "warped_hyphae")))
            )
    );

    public static final Block CRIMSON_HYPHAE_SLAB = register("crimson_hyphae_slab",
            new SlabBlock(CRIMSON_STEM.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crimson_hyphae")))
            )
    );

    public static final Block PALE_OAK_WOOD_SLAB = register("pale_oak_wood_slab",
            new SlabBlock(PALE_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "pale_oak_wood")))
            )
    );
    ...
    public static final Block STRIPPED_SPRUCE_SLAB = register("stripped_spruce_slab",
            new SlabBlock(STRIPPED_SPRUCE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_spruce")))
            )
    );

    public static final Block STRIPPED_BIRCH_SLAB = register("stripped_birch_slab",
            new SlabBlock(STRIPPED_BIRCH_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_birch")))
            )
    );

    public static final Block STRIPPED_JUNGLE_SLAB = register("stripped_jungle_slab",
            new SlabBlock(STRIPPED_JUNGLE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_jungle")))
            )
    );

    public static final Block STRIPPED_ACACIA_SLAB = register("stripped_acacia_slab",
            new SlabBlock(STRIPPED_ACACIA_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_acacia")))
            )
    );

    public static final Block STRIPPED_DARK_OAK_SLAB = register("stripped_dark_oak_slab",
            new SlabBlock(STRIPPED_DARK_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_dark_oak")))
            )
    );

    public static final Block STRIPPED_MANGROVE_SLAB = register("stripped_mangrove_slab",
            new SlabBlock(MANGROVE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_mangrove")))
            )
    );

    public static final Block STRIPPED_CHERRY_SLAB = register("stripped_cherry_slab",
            new SlabBlock(CHERRY_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_cherry")))
            )
    );

    public static final Block STRIPPED_WARPED_SLAB = register("stripped_warped_slab",
            new SlabBlock(STRIPPED_WARPED_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_warped")))
            )
    );

    public static final Block STRIPPED_CRIMSON_SLAB = register("stripped_crimson_slab",
            new SlabBlock(STRIPPED_CRIMSON_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_crimson")))
            )
    );
    ...
    public static final Block ICE_SLAB = register("ice_slab",
            new IceSlabBlock(ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "ice_slab")))
            )
    );

    public static final Block PACKED_ICE_SLAB = register("packed_ice_slab",
            new SlabBlock(PACKED_ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "packed_ice_slab")))
            )
    );

    public static final Block BLUE_ICE_SLAB = register("blue_ice_slab",
            new SlabBlock(BLUE_ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "blue_ice_slab")))
            )
    );
    ...
    public static final Block CHISELED_STONE_BRICK_SLAB = register("chiseled_stone_brick_slab",
            new SlabBlock(CHISELED_STONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_stone_brick_slab")))
            )
    );

    public static final Block CRACKED_STONE_BRICK_SLAB = register("cracked_stone_brick_slab",
            new SlabBlock(CRACKED_STONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_stone_brick_slab")))
            )
    );

    public static final Block CHISELED_SANDSTONE_SLAB = register("chiseled_sandstone_slab",
            new SlabBlock(CHISELED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_sandstone_slab")))
            )
    );

    public static final Block CHISELED_RED_SANDSTONE_SLAB = register("chiseled_red_sandstone_slab",
            new SlabBlock(CHISELED_RED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_red_sandstone_slab")))
            )
    );

    public static final Block BASALT_SLAB = register("basalt_slab",
            new SlabBlock(BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "basalt_slab")))
            )
    );

    public static final Block SMOOTH_BASALT_SLAB = register("smooth_basalt_slab",
            new SlabBlock(SMOOTH_BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_basalt_slab")))
            )
    );

    public static final Block POLISHED_BASALT_SLAB = register("polished_basalt_slab",
            new SlabBlock(POLISHED_BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "polished_basalt_slab")))
            )
    );

    public static final Block CHISELED_POLISHED_BLACKSTONE_SLAB = register("chiseled_polished_blackstone_slab",
            new SlabBlock(CHISELED_POLISHED_BLACKSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_polished_blackstone_slab")))
            )
    );

    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB = register("cracked_polished_blackstone_brick_slab",
            new SlabBlock(CRACKED_POLISHED_BLACKSTONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_polished_blackstone_brick_slab")))
            )
    );

    public static final Block CALCITE_SLAB = register("calcite_slab",
            new SlabBlock(CALCITE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "calcite_slab")))
            )
    );

    public static final Block CHISELED_TUFF_SLAB = register("chiseled_tuff_slab",
            new SlabBlock(CHISELED_TUFF.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_tuff_slab")))
            )
    );

    public static final Block CHISELED_TUFF_BRICK_SLAB = register("chiseled_tuff_brick_slab",
            new SlabBlock(CHISELED_TUFF_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_tuff_brick_slab")))
            )
    );

    public static final Block DEEPSLATE_SLAB = register("deepslate_slab",
            new SlabBlock(DEEPSLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "deepslate_slab")))
            )
    );

    public static final Block CHISELED_DEEPSLATE_SLAB = register("chiseled_deepslate_slab",
            new SlabBlock(CHISELED_DEEPSLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_deepslate_slab")))
            )
    );

    public static final Block CRACKED_DEEPSLATE_BRICK_SLAB = register("cracked_deepslate_brick_slab",
            new SlabBlock(CRACKED_DEEPSLATE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_deepslate_brick_slab")))
            )
    );

    public static final Block CRACKED_DEEPSLATE_TILE_SLAB = register("cracked_deepslate_tile_slab",
            new SlabBlock(CRACKED_DEEPSLATE_TILES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_deepslate_tile_slab")))
            )
    );

    public static final Block DRIPSTONE_SLAB = register("dripstone_slab",
            new SlabBlock(DRIPSTONE_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dripstone_slab")))
            )
    );

    public static final Block CRACKED_NETHER_BRICK_SLAB = register("cracked_nether_brick_slab",
            new SlabBlock(CRACKED_NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_nether_brick_slab")))
            )
    );

    public static final Block CHISELED_NETHER_BRICK_SLAB = register("chiseled_nether_brick_slab",
            new SlabBlock(CHISELED_NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_nether_brick_slab")))
            )
    );

    public static final Block QUARTZ_BRICK_SLAB = register("quartz_brick_slab",
            new SlabBlock(QUARTZ_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "quartz_brick_slab")))
            )
    );

    public static final Block CHISELED_QUARTZ_SLAB = register("chiseled_quartz_slab",
            new SlabBlock(CHISELED_QUARTZ_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_quartz_slab")))
            )
    );

    public static final Block QUARTZ_PILLAR_SLAB = register("quartz_pillar_slab",
            new SlabBlock(QUARTZ_PILLAR.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "quartz_pillar_slab")))
            )
    );

    public static final Block END_STONE_SLAB = register("end_stone_slab",
            new SlabBlock(END_STONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "end_stone_slab")))
            )
    );

    public static final Block PURPUR_PILLAR_SLAB = register("purpur_pillar_slab",
            new SlabBlock(PURPUR_PILLAR.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "purpur_pillar_slab")))
            )
    );

    public static final Block OBSIDIAN_SLAB = register("obsidian_slab",
            new SlabBlock(OBSIDIAN.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "obsidian_slab")))
            )
    );

    public static final Block CRYING_OBSIDIAN_SLAB = register("crying_obsidian_slab",
            new SlabBlock(CRYING_OBSIDIAN.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crying_obsidian_slab")))
            )
    );
    ...
    public static final Block TERRACOTTA_SLAB = register("terracotta_slab",
            new SlabBlock(TERRACOTTA.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "terracotta_slab")))
            )
    );
    ...
    public static final Block IRON_STAIRS = register("iron_stairs",
            new StairBlock(IRON_BLOCK.defaultBlockState(), IRON_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "iron_stairs")))
            )
    );

    public static final Block GOLD_STAIRS = register("gold_stairs",
            new StairBlock(GOLD_BLOCK.defaultBlockState(), GOLD_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "gold_stairs")))
            )
    );

    public static final Block NETHERITE_STAIRS = register("netherite_stairs",
            new StairBlock(NETHERITE_BLOCK.defaultBlockState(), NETHERITE_BLOCK.properties().sound(SoundType.NETHERITE_BLOCK)
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "netherite_stairs")))
            )
    );
    ...
    public static final Block OAK_LOG_STAIRS = register("oak_log_stairs",
            new StairBlock(OAK_PLANKS.defaultBlockState(), OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "oak_log_stairs")))
            )
    );

    public static final Block SPRUCE_LOG_STAIRS = register("spruce_log_stairs",
            new StairBlock(SPRUCE_PLANKS.defaultBlockState(), SPRUCE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "spruce_log_stairs")))
            )
    );

    public static final Block BIRCH_LOG_STAIRS = register("birch_log_stairs",
            new StairBlock(BIRCH_PLANKS.defaultBlockState(), BIRCH_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "birch_log_stairs")))
            )
    );

    public static final Block JUNGLE_LOG_STAIRS = register("jungle_log_stairs",
            new StairBlock(JUNGLE_PLANKS.defaultBlockState(), JUNGLE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "jungle_log_stairs")))
            )
    );

    public static final Block ACACIA_LOG_STAIRS = register("acacia_log_stairs",
            new StairBlock(ACACIA_PLANKS.defaultBlockState(), ACACIA_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "acacia_log_stairs")))
            )
    );

    public static final Block DARK_OAK_LOG_STAIRS = register("dark_oak_log_stairs",
            new StairBlock(DARK_OAK_PLANKS.defaultBlockState(), DARK_OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_oak_log_stairs")))
            )
    );

    public static final Block MANGROVE_LOG_STAIRS = register("mangrove_log_stairs",
            new StairBlock(MANGROVE_PLANKS.defaultBlockState(), MANGROVE_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "mangrove_log_stairs")))
            )
    );

    public static final Block CHERRY_LOG_STAIRS = register("cherry_log_stairs",
            new StairBlock(CHERRY_PLANKS.defaultBlockState(), CHERRY_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cherry_log_stairs")))
            )
    );

    public static final Block WARPED_STEM_STAIRS = register("warped_stem_stairs",
            new StairBlock(WARPED_STEM.defaultBlockState(), WARPED_STEM.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "warped_stem_stairs")))
            )
    );

    public static final Block CRIMSON_STEM_STAIRS = register("crimson_stem_stairs",
            new StairBlock(CRIMSON_STEM.defaultBlockState(), CRIMSON_STEM.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crimson_stem_stairs")))
            )
    );

    public static final Block PALE_OAK_LOG_STAIRS = register("pale_oak_log_stairs",
            new StairBlock(PALE_OAK_PLANKS.defaultBlockState(), PALE_OAK_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "pale_oak_log_stairs")))
            )
    );
    ...
    public static final Block SPRUCE_WOOD_STAIRS = register("spruce_wood_stairs",
            new StairBlock(SPRUCE_WOOD.defaultBlockState(), SPRUCE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "spruce_wood_stairs")))
            )
    );

    public static final Block BIRCH_WOOD_STAIRS = register("birch_wood_stairs",
            new StairBlock(BIRCH_WOOD.defaultBlockState(), BIRCH_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "birch_wood_stairs")))
            )
    );

    public static final Block JUNGLE_WOOD_STAIRS = register("jungle_wood_stairs",
            new StairBlock(JUNGLE_WOOD.defaultBlockState(), JUNGLE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "jungle_wood_stairs")))
            )
    );

    public static final Block ACACIA_WOOD_STAIRS = register("acacia_wood_stairs",
            new StairBlock(ACACIA_WOOD.defaultBlockState(), ACACIA_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "acacia_wood_stairs")))
            )
    );

    public static final Block DARK_OAK_WOOD_STAIRS = register("dark_oak_wood_stairs",
            new StairBlock(DARK_OAK_WOOD.defaultBlockState(), DARK_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dark_oak_wood_stairs")))
            )
    );

    public static final Block MANGROVE_WOOD_STAIRS = register("mangrove_wood_stairs",
            new StairBlock(MANGROVE_WOOD.defaultBlockState(), MANGROVE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "mangrove_wood_stairs")))
            )
    );

    public static final Block CHERRY_WOOD_STAIRS = register("cherry_wood_stairs",
            new StairBlock(CHERRY_WOOD.defaultBlockState(), CHERRY_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cherry_wood_stairs")))
            )
    );

    public static final Block BAMBOO_BLOCK_STAIRS = register("bamboo_block_stairs",
            new StairBlock(BAMBOO_PLANKS.defaultBlockState(), BAMBOO_PLANKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "bamboo_block_stairs")))
            )
    );

    public static final Block WARPED_HYPHAE_STAIRS = register("warped_hyphae_stairs",
            new StairBlock(WARPED_HYPHAE.defaultBlockState(), WARPED_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "warped_hyphae_stairs")))
            )
    );

    public static final Block CRIMSON_HYPHAE_STAIRS = register("crimson_hyphae_stairs",
            new StairBlock(CRIMSON_HYPHAE.defaultBlockState(), CRIMSON_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crimson_hyphae_stairs")))
            )
    );

    public static final Block PALE_OAK_WOOD_STAIRS = register("pale_oak_wood_stairs",
            new StairBlock(PALE_OAK_WOOD.defaultBlockState(), PALE_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "pale_oak_wood_stairs")))
            )
    );
    ...
    public static final Block STRIPPED_SPRUCE_STAIRS = register("stripped_spruce_stairs",
            new StairBlock(STRIPPED_SPRUCE_WOOD.defaultBlockState(), STRIPPED_SPRUCE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_spruce_stairs")))
            )
    );

    public static final Block STRIPPED_BIRCH_STAIRS = register("stripped_birch_stairs",
            new StairBlock(STRIPPED_BIRCH_WOOD.defaultBlockState(), STRIPPED_BIRCH_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_birch_stairs")))
            )
    );

    public static final Block STRIPPED_JUNGLE_STAIRS = register("stripped_jungle_stairs",
            new StairBlock(STRIPPED_JUNGLE_WOOD.defaultBlockState(), STRIPPED_JUNGLE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_jungle_stairs")))
            )
    );

    public static final Block STRIPPED_ACACIA_STAIRS = register("stripped_acacia_stairs",
            new StairBlock(STRIPPED_ACACIA_WOOD.defaultBlockState(), STRIPPED_ACACIA_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_acacia_stairs")))
            )
    );

    public static final Block STRIPPED_DARK_OAK_STAIRS = register("stripped_dark_oak_stairs",
            new StairBlock(STRIPPED_DARK_OAK_WOOD.defaultBlockState(), STRIPPED_DARK_OAK_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_dark_oak_stairs")))
            )
    );

    public static final Block STRIPPED_MANGROVE_STAIRS = register("stripped_mangrove_stairs",
            new StairBlock(MANGROVE_WOOD.defaultBlockState(), MANGROVE_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_mangrove_stairs")))
            )
    );

    public static final Block STRIPPED_CHERRY_STAIRS = register("stripped_cherry_stairs",
            new StairBlock(CHERRY_WOOD.defaultBlockState(), CHERRY_WOOD.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_cherry_stairs")))
            )
    );

    public static final Block STRIPPED_WARPED_STAIRS = register("stripped_warped_stairs",
            new StairBlock(STRIPPED_WARPED_HYPHAE.defaultBlockState(), STRIPPED_WARPED_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_warped_stairs")))
            )
    );

    public static final Block STRIPPED_CRIMSON_STAIRS = register("stripped_crimson_stairs",
            new StairBlock(STRIPPED_CRIMSON_HYPHAE.defaultBlockState(), STRIPPED_CRIMSON_HYPHAE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "stripped_crimson_stairs")))
            )
    );
    ...
    public static final Block ICE_STAIRS = register("ice_stairs",
            new IceStairsBlock(ICE.defaultBlockState(), ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "ice_stairs")))
            )
    );

    public static final Block PACKED_ICE_STAIRS = register("packed_ice_stairs",
            new StairBlock(PACKED_ICE.defaultBlockState(), PACKED_ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "packed_ice_stairs")))
            )
    );

    public static final Block BLUE_ICE_STAIRS = register("blue_ice_stairs",
            new StairBlock(BLUE_ICE.defaultBlockState(), BLUE_ICE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "blue_ice_stairs")))
            )
    );
    ...
    public static final Block CHISELED_STONE_BRICK_STAIRS = register("chiseled_stone_brick_stairs",
            new StairBlock(CHISELED_STONE_BRICKS.defaultBlockState(), CHISELED_STONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_stone_brick_stairs")))
            )
    );

    public static final Block CRACKED_STONE_BRICK_STAIRS = register("cracked_stone_brick_stairs",
            new StairBlock(CRACKED_STONE_BRICKS.defaultBlockState(), CRACKED_STONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_stone_brick_stairs")))
            )
    );

    public static final Block SMOOTH_STONE_STAIRS = register("smooth_stone_stairs",
            new StairBlock(SMOOTH_STONE.defaultBlockState(), SMOOTH_STONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_stone_stairs")))
            )
    );

    public static final Block CHISELED_SANDSTONE_STAIRS = register("chiseled_sandstone_stairs",
            new StairBlock(CHISELED_SANDSTONE.defaultBlockState(), CHISELED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_sandstone_stairs")))
            )
    );

    public static final Block CUT_SANDSTONE_STAIRS = register("cut_sandstone_stairs",
            new StairBlock(CUT_SANDSTONE.defaultBlockState(), CUT_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cut_sandstone_stairs")))
            )
    );

    public static final Block CHISELED_RED_SANDSTONE_STAIRS = register("chiseled_red_sandstone_stairs",
            new StairBlock(CHISELED_RED_SANDSTONE.defaultBlockState(), CHISELED_RED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_red_sandstone_stairs")))
            )
    );

    public static final Block CUT_RED_SANDSTONE_STAIRS = register("cut_red_sandstone_stairs",
            new StairBlock(CUT_RED_SANDSTONE.defaultBlockState(), CUT_RED_SANDSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cut_red_sandstone_stairs")))
            )
    );

    public static final Block BASALT_STAIRS = register("basalt_stairs",
            new StairBlock(BASALT.defaultBlockState(), BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "basalt_stairs")))
            )
    );

    public static final Block SMOOTH_BASALT_STAIRS = register("smooth_basalt_stairs",
            new StairBlock(SMOOTH_BASALT.defaultBlockState(), SMOOTH_BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "smooth_basalt_stairs")))
            )
    );

    public static final Block POLISHED_BASALT_STAIRS = register("polished_basalt_stairs",
            new StairBlock(POLISHED_BASALT.defaultBlockState(), POLISHED_BASALT.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "polished_basalt_stairs")))
            )
    );

    public static final Block CHISELED_POLISHED_BLACKSTONE_STAIRS = register("chiseled_polished_blackstone_stairs",
            new StairBlock(CHISELED_POLISHED_BLACKSTONE.defaultBlockState(), CHISELED_POLISHED_BLACKSTONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_polished_blackstone_stairs")))
            )
    );

    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS = register("cracked_polished_blackstone_brick_stairs",
            new StairBlock(CRACKED_POLISHED_BLACKSTONE_BRICKS.defaultBlockState(), CRACKED_POLISHED_BLACKSTONE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_polished_blackstone_brick_stairs")))
            )
    );

    public static final Block CALCITE_STAIRS = register("calcite_stairs",
            new StairBlock(CALCITE.defaultBlockState(), CALCITE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "calcite_stairs")))
            )
    );

    public static final Block CHISELED_TUFF_STAIRS = register("chiseled_tuff_stairs",
            new StairBlock(CHISELED_TUFF.defaultBlockState(), CHISELED_TUFF.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_tuff_stairs")))
            )
    );

    public static final Block CHISELED_TUFF_BRICK_STAIRS = register("chiseled_tuff_brick_stairs",
            new StairBlock(CHISELED_TUFF_BRICKS.defaultBlockState(), CHISELED_TUFF_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_tuff_brick_stairs")))
            )
    );

    public static final Block DEEPSLATE_STAIRS = register("deepslate_stairs",
            new StairBlock(DEEPSLATE.defaultBlockState(), DEEPSLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "deepslate_stairs")))
            )
    );

    public static final Block CHISELED_DEEPSLATE_STAIRS = register("chiseled_deepslate_stairs",
            new StairBlock(CHISELED_DEEPSLATE.defaultBlockState(), CHISELED_DEEPSLATE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_deepslate_stairs")))
            )
    );

    public static final Block CRACKED_DEEPSLATE_BRICK_STAIRS = register("cracked_deepslate_brick_stairs",
            new StairBlock(CRACKED_DEEPSLATE_BRICKS.defaultBlockState(), CRACKED_DEEPSLATE_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_deepslate_brick_stairs")))
            )
    );

    public static final Block CRACKED_DEEPSLATE_TILE_STAIRS = register("cracked_deepslate_tile_stairs",
            new StairBlock(CRACKED_DEEPSLATE_TILES.defaultBlockState(), CRACKED_DEEPSLATE_TILES.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_deepslate_tile_stairs")))
            )
    );

    public static final Block DRIPSTONE_STAIRS = register("dripstone_stairs",
            new StairBlock(DRIPSTONE_BLOCK.defaultBlockState(), DRIPSTONE_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "dripstone_stairs")))
            )
    );

    public static final Block CRACKED_NETHER_BRICK_STAIRS = register("cracked_nether_brick_stairs",
            new StairBlock(CRACKED_NETHER_BRICKS.defaultBlockState(), CRACKED_NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "cracked_nether_brick_stairs")))
            )
    );

    public static final Block CHISELED_NETHER_BRICK_STAIRS = register("chiseled_nether_brick_stairs",
            new StairBlock(CHISELED_NETHER_BRICKS.defaultBlockState(), CHISELED_NETHER_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_nether_brick_stairs")))
            )
    );

    public static final Block QUARTZ_BRICK_STAIRS = register("quartz_brick_stairs",
            new StairBlock(QUARTZ_BRICKS.defaultBlockState(), QUARTZ_BRICKS.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "quartz_brick_stairs")))
            )
    );

    public static final Block CHISELED_QUARTZ_STAIRS = register("chiseled_quartz_stairs",
            new StairBlock(CHISELED_QUARTZ_BLOCK.defaultBlockState(), CHISELED_QUARTZ_BLOCK.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "chiseled_quartz_stairs")))
            )
    );

    public static final Block QUARTZ_PILLAR_STAIRS = register("quartz_pillar_stairs",
            new StairBlock(QUARTZ_PILLAR.defaultBlockState(), QUARTZ_PILLAR.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "quartz_pillar_stairs")))
            )
    );

    public static final Block END_STONE_STAIRS = register("end_stone_stairs",
            new StairBlock(END_STONE.defaultBlockState(), END_STONE.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "end_stone_stairs")))
            )
    );

    public static final Block PURPUR_PILLAR_STAIRS = register("purpur_pillar_stairs",
            new StairBlock(PURPUR_PILLAR.defaultBlockState(), PURPUR_PILLAR.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "purpur_pillar_stairs")))
            )
    );

    public static final Block OBSIDIAN_STAIRS = register("obsidian_stairs",
            new StairBlock(OBSIDIAN.defaultBlockState(), OBSIDIAN.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "obsidian_stairs")))
            )
    );

    public static final Block CRYING_OBSIDIAN_STAIRS = register("crying_obsidian_stairs",
            new StairBlock(CRYING_OBSIDIAN.defaultBlockState(), CRYING_OBSIDIAN.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "crying_obsidian_stairs")))
            )
    );
    ...
    public static final Block TERRACOTTA_STAIRS = register("terracotta_stairs",
            new StairBlock(TERRACOTTA.defaultBlockState(), TERRACOTTA.properties()
                    .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, "terracotta_stairs")))
            )
    );
    ...
    public static Block register(String name, Block block) {
        Identifier id = Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, name);
    ...
    public static Block registerWithoutItem(String name, Block block) {
        return Registry.register(BuiltInRegistries.BLOCK, Identifier.fromNamespaceAndPath(SlabsAndStairs.MOD_ID, name), block);
    }
