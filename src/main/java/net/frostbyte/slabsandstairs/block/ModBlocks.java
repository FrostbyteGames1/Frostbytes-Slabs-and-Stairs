...
public class ModBlocks {
    ...
    public static final Block TUFF_WALL = registerBlock("tuff_wall", new WallBlock(Blocks.TUFF_WALL.getSettings()));
    public static final Block TUFF_SLAB = registerBlock("tuff_slab", new SlabBlock(Blocks.TUFF_SLAB.getSettings()));
    public static final Block TUFF_STAIRS = registerBlock("tuff_stairs", new StairsBlock(Blocks.TUFF_STAIRS.getDefaultState(), Blocks.TUFF_STAIRS.getSettings()));
    public static final Block SAWMILL = registerBlock("sawmill", new StonecutterBlock(STONECUTTER.getSettings()));
    ...
    public static final Block CHISELED_TUFF_BRICK_WALL = registerBlock("chiseled_tuff_brick_wall",
    ...
    public static final Block CHISELED_TUFF_BRICK_SLAB = registerBlock("chiseled_tuff_brick_slab",
    ...
    public static final Block CHISELED_TUFF_BRICK_STAIRS = registerBlock("chiseled_tuff_brick_stairs",
    ...
    Registry.register(Registries.ITEM, Identifier.of(SlabsAndStairs.MOD_ID, name),
