...
- Previous versions of this mod contained many conflicts with vanilla recipes. This is no longer the case, as I have changed all conflicting recipes. I have also added a Sawmill block (crafted like a stonecutter, but with wood instead of stone), in order to reenable the use of the wood-to-planks recipe.
